...
if __name__ == '__main__':
    ...
    for i in tqdm(range(len(scan_ids))):
        ...
        if "_00" in scan_id:
            ...
            objects_relations_pred =  obj_extractor.get_objects_relations_pred(df.utterance[i].lower())
    ...
    save_in_csv(lst=pred_objs_name_all_scenes, saving_name="./data/pred_objs_total_opt2.csv")

    pred_objs_name_all_scenes = random.sample(pred_objs_name_all_scenes, 3000)
    save_in_csv(lst=pred_objs_name_all_scenes, saving_name="./data/pred_objs_3000_opt2.csv")
