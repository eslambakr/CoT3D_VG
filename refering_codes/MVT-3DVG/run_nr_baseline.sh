...
/home/abdelrem/anaconda3/envs/refer3d_cuda/bin/python -u train_referit3d.py \
    ...
    -referit3D-file /home/abdelrem/3d_codes/CoT3D_VG/extract_anchors/nr3D_with_OUR_GT.csv \
    --bert-pretrain-path /home/abdelrem/3d_codes/MVT-3DVG/weights/bert-base-uncased/ \
    --log-dir logs/pseudoWneg_MVT_nr3d_anchors7_CoTLang_drop15%_data70%_16head_selfCons_distLoss \
    --n-workers 8 \
